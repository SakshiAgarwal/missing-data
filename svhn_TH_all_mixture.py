...
### Load model 
checkpoint = torch.load(ENCODER_PATH + ".pth", map_location='cuda:1')
#print(checkpoint)
encoder.load_state_dict(checkpoint['model_state_dict'])
checkpoint = torch.load(DECODER_PATH + ".pth", map_location='cuda:1')
...
for iterations in range(1):
    for i in [-1]:
        ...
        for data in test_loader:
            ...
            file_save_iwae = results + str(-1) + "/pickled_files/svhn_TH_infered_iwae_p_mixture.pkl"
